...
BOT_TOKEN = environ.get('BOT_TOKEN','5532990897:AAGDd9X1ifFbcwm9PcLzuCzYKlYWHZUVjd4')

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/8301eabe638567d8f96f8.jpg https://graph.org/file/5a9647f73bfbf7c7711d9.jpg')).split()
...
DATABASE_NAME = environ.get('DATABASE_NAME', "KPL1")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MKS_REQUESTGROUP')
...
FILE_GROUP2 = int(environ.get('FILE_GROUP2', "-1001804560420"))
...
CUSTOM_FILE_CAPTION2 = environ.get("CUSTOM_FILE_CAPTION", f"{script.CAPTION2}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION2)
...
DOWNLOAD_BUTTON = is_enabled((environ.get('PROTECT_CONTENT', "False")), False)
...
LOG_STR += ("DOWNLOAD_BUTTON Is Enabled, bot will be suggesting related movies if movie not found\n" if DOWNLOAD_BUTTON else "DOWNLOAD_BUTTON Mode disabled\n")
