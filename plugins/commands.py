    ...
    if not files_:
        ...
        try:
            ...
            if CUSTOM_FILE_CAPTION:
                try:
                    f_caption=CUSTOM_FILE_CAPTION.format(file_name= '' if title is None else title, file_size='' if size is None else size, user_link='' if user is None else user, file_caption='')
                except:
                    return
