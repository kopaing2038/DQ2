...
from info import DATABASE_URI, DATABASE_NAME, COLLECTION_NAME2, USE_CAPTION_FILTER, MAX_B_TN
...
async def get_search_results2(chat_id, query, file_type=None, max_results=10, offset=0, filter=False, video: bool = True, photo: bool = True):
...
async def get_bad_files2(query, file_type=None, filter=False):
    """For given query return (results, next_offset)"""
    query = query.strip()
    #if filter:
        #better ?
